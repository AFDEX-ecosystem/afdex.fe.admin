<template>
  <div class="content_wrap">
    <div class="grid_content">
      <div class="page_toparea">
        <h2 class="page_title">전공능력진단</h2>
      </div>
    </div>
    <div class="grid_content">
      <div class="sub_section_md">
        <div class="diag_intro major_ability">
          <div>
            학과별로 설정되어 있는 전공능력을<br />
            스스로 진단해보고 나의 강점과 약점을 정확하게 파악해 자기계발의 방향성을 정하는 검사입니다.
          </div>
        </div>
        <div class="box guide_info">
          <div class="guide_section">
            <h4>전공능력진단의 목적 및 활용</h4>
            <p class="txt">
              전공능력은 대학의 교육목적, 교육목표, 인재상에 적합한 인재 양성에 필요한 학과/전공별 역량으로, 4년간의
              교육과정을 통해 사회에 진출하여 전공과 관련한 실무를 성공적으로 실행하는데 필요한 능력입니다.
              전공능력진단을 통해 자신의 전공에 관한 역량을 객관적으로 파악하고 그 결과를 기초로 역량 개발을 함으로써
              4차 산업혁명시대에 성공하는 전문인대로 발전하게 됩니다. 특히 분석에만 그치는 것이 아니라, 자신의 강점과
              약점을 개발하기 위한 자기개발 가이드를 제안합니다.
            </p>
          </div>
        </div>
      </div>
      <div class="diag_grid">
        <div class="diag_card_wrap">
          <div class="section_tit_wrap">
            <h4 class="section_tit">전공능력진단 목록</h4>
          </div>
            ...
            <swiper v-bind="swiperOptions" :modules="modules">
              <swiper-slide class="box">
                <div class="test_stare">
                  ...
                  <div class="title">
                    <p>
                      2024학년도 전공능력진단 2024학년도 전공능력진단 2024학년도 전공능력진단 2024학년도 전공능력진단
                    </p>
                  </div>
        ...
        <div class="diag_rslt_wrap">
          <div class="section_tit_wrap">
            <h4 class="section_tit">전공능력진단 결과</h4>
          </div>
          <div class="box test_result">
            ...
            <ul class="testresult_list">
              <li>
                <div>
                  <p class="title">2024학년도 전공능력진단 (1차)</p>
                  <div class="function">
              ...
              <li>
                <div>
                  ...
                  <div class="function">
                    <p class="date">응시일<span>2024.04.11</span></p>
                    <span class="label">응시완료</span>
                    <button type="button" @click="$router.push('/diag/majorAbility/result')">결과보기</button>
                  </div>
                </div>
              </li>
              <li>
  ...
  <PopupView v-model="isPopups[0]" class="medium">
    ...
    <template #footer>
      ...
      <button type="button" class="btn_round2 btn_primary btn_xl" @click="$router.push('/diag/majorAbility/do')">
        동의
      </button>
    </template>
    <div class="privacy_wrap">
      <div class="privacy_box">
        <ul class="list_dot">
          ...
          <li>수집 및 이용 목적 : 핵심역량진단 조사 통계 분석</li>
          <li>보유 및 이용기간 : 3개월</li>
        </ul>
      </div>
