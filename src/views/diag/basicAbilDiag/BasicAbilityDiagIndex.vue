<template>
  <div class="content_wrap">
    ...
    <div class="grid_content">
      <div class="sub_section_md">
        <div class="diag_intro basic_ability">
          <div>기초학력진단 관한 설명 글 입니다.</div>
        </div>
      </div>
      <div class="diag_grid">
        <div class="diag_card_wrap">
          <div class="section_tit_wrap">
            <h4 class="section_tit">기초학력진단 목록</h4>
          </div>
            ...
            <swiper v-bind="swiperOptions" :modules="modules">
              <swiper-slide class="box">
                <div class="test_stare">
                  ...
                  <div class="title">
                    <p>
                      2024학년도 기초학력진단 2024학년도 기초학력진단 2024학년도 기초학력진단 2024학년도 기초학력진단
                    </p>
                  </div>
        ...
        <div class="diag_rslt_wrap">
          <div class="section_tit_wrap">
            <h4 class="section_tit">기초학력진단 결과</h4>
          </div>
          <div class="box test_result">
            ...
            <ul class="testresult_list">
              <li>
                <div>
                  <p class="title">2024학년도 기초학력진단 (1차)</p>
                  <div class="function">
              ...
              <li>
                <div>
                  ...
                  <div class="function">
                    <p class="date">응시일<span>2024.04.11</span></p>
                    <span class="label">응시완료</span>
                    <button type="button" @click="$router.push('/diag/basicAbility/result')">결과보기</button>
                  </div>
                </div>
              </li>
              <li>
  ...
  <PopupView v-model="isPopups[0]" class="medium">
    ...
    <template #footer>
      ...
      <button type="button" class="btn_round2 btn_primary btn_xl" @click="$router.push('/diag/basicAbility/do')">
        동의
      </button>
    </template>
    <div class="privacy_wrap">
      <div class="privacy_box">
        <ul class="list_dot">
          ...
          <li>수집 및 이용 목적 : 기초학력진단 조사 통계 분석</li>
          <li>보유 및 이용기간 : 3개월</li>
        </ul>
      </div>
